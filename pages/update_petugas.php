            ...
            <div class="row">
              <div class="col-7">
                <table class="table table-borderless" style="font-size: larger;">
                  <tr>
                    ...
                    <td>
                      <input type="text" name="nama_petugas" id="nama_petugas" autofocus required value="<?= $t['nama_petugas']; ?>">
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <input type="password" name="password1" id="password1" required value="<?= $t['password_petugas']; ?>">
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <input type="password" name="password2" id="password2" required value="<?= $t['password_petugas']; ?>">
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <img src="../dist/img/<?= $t['foto_petugas']; ?>" alt="">
              ...
              <div class="col-5">
                ...
                <div class="row mt-4 d-flex justify-content-end mr-3">
                  <a href="detail_assign.php?id=<?= $t['nip']; ?>" class="btn btn-light btn-lg">
                    BACK
                  </a>
                </div>
              </div>
