  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-primary" style="padding-top:6px; font-size: 20px;">Assign Tugas</a>
        </li>
      </ul>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="card">
          <!-- /.card-header -->
          <div class="card-body">
            <form action="save_tugas.php" method="POST">
              <div class="form-group">
                <select name="pilihpetugas" class="btn btn-light dropdown-toggle float-left ml-2 mr-2">
                  <div class="dropdown-menu dropdown-menu-left">
                    <option hidden selected>Pilih Petugas</option>
                    <?php foreach ($petugas as $t) : ?>
                      <option class="dropdown-item" value="<?= $t['id_petugas']; ?>" style="font-size: 20px; margin:10px;"><?= $t['nama_petugas']; ?></option>
                    <?php endforeach; ?>
                  </div>
                </select>
                <button class="btn btn-primary float-left ml-2" name="simpan">Assign Tugas</button>

                <table id="example2" class="table table-borderless table-striped table-hover" style="font-size: larger;">
                  <thead>
                    <tr>
                      <th></th>
                      <th>No.</th>
                  ...
                  <tbody>
                    ...
                    foreach ($pelanggan as $p) : ?>
                      <tr>
                        <td>
                          <input type="checkbox" name="cek_idpel[]" value="<?= $p['idpel']; ?>">
                        </td>
                        <td><?= $i++; ?></td>
                        <td><?= $p['idpel']; ?></td>
                        <td><?= $p['nama']; ?></td>
                        ...
                        <td><?= $p['rupiah_prr']; ?></td>
                        <td>
                          <a href="detail_assign.php?id=<?= $p['id_pelanggan']; ?>"><button type="button" class="btn btn-primary">Detail</button></a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
